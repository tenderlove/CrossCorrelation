"""
This is just a slight hack of astroML.correlation. In that code they
only had the option of computing the auto-correlation, via
w = (DD-2DR+RR)/RR. I added functionality to compute the cross-correlation:
w = (D1D2 - D1R2 - D2R1 + R1R2)/R1R2.


Tools for computing two-point correlation functions.
"""

from astroML import warnings
import numpy as np
...
def two_point(data, bins, method='landy-szalay',
